...
Proof.
  ...
  simpl. destruct a; try (rewrite optimize_0plus_sound; rewrite optimize_0plus_sound; reflexivity).
...
Proof.
 ...
 Case "->".
   intros H;
   aevalR_cases (induction H) SCase; simpl; try (rewrite IHaevalR1;  rewrite IHaevalR2;  reflexivity); try reflexivity.
 Case "<-".
...
Theorem update_eq : forall n x st,
  (update st x n) x = n.
Proof.
  intros. unfold update. destruct x. destruct n. destruct (eq_id_dec (Id n0) (Id n0)) as [a | b]. reflexivity.
  contradiction b. reflexivity. destruct (eq_id_dec (Id n0) (Id n0)). reflexivity. contradiction n1. reflexivity.
Qed.
(** [] *)
...
Proof.
   intros. unfold update. destruct (eq_id_dec x2 x1). contradiction. reflexivity. Qed.
(** [] *)
...
Proof.
  intros. unfold update. destruct (eq_id_dec x1 x3). destruct (eq_id_dec x2 x3).
  subst x3. contradiction H. reflexivity. destruct (eq_id_dec x2 x3); reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  remember (WHILE BTrue DO SKIP END) as loopdef eqn:Heqloopdef.
    (* Proceed by induction on the assumed derivation showing that
     ...
     subst; inversion H. apply IHcontra2. apply Heqloopdef. 
Qed.
(** [] *)
