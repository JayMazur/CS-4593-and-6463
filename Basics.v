...
(** Can you explain why this happens? Step through these proofs in Coq and notice how the goal and
    context change. *)
...
| A => O
| B n' => double (bin2un n')
| C n' => S (double (bin2un n'))
end.

Theorem bin_comm : forall n : bin,
bin2un(bin_plus n) = S (bin2un n).
Proof.
intros n.
induction n.
reflexivity.
