...
Proof.
  ...
  step_cases (induction e1) Case; intros y2 e2; step_cases (inversion e2) SCase.
    reflexivity. inversion H2. inversion H3.
...
Theorem bool_step_prop1X : ~bool_step_prop1.
Proof.
...
Theorem bool_step_prop2X : ~bool_step_prop2.
Proof.
...
Theorem bool_step_prop3X : bool_step_prop3.
Proof.
...
Lemma multistep_congr_2 : forall t1 t2 t2',
     ...
     P t1 t2 ==>* P t1 t2'.
Proof.
  intros t1 t2 t2' a H. induction H.
  apply multi_refl. eapply multi_step.
  apply ST_Plus2. apply a. apply H. apply IHmulti.
Qed.
(** [] *)
